...
/*   Updated: 2024/05/26 15:15:07 by fbelahse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void wbs::Response::set_env(){
	...
	// map_env.insert(std::make_pair("SERVER_PORT", "8080")); //from request
...
char** &wbs::Response::get_envi_var(){
	set_env();
	create_envp(); //don't forget to free!! it's called free_envp()
	return envp_c;
}
